#!/usr/bin/python3
"""
This code is used as an example for the Chapter10 of the bookDevOps With Linux
"""
...
def check_card(func):
    ...
    def validation(*args, **kwargs):
        """
        This function is a decorator, which will
        return the function corresponding to the respective action
        """
...
def transaction():
    """
    This function is resposible to expose the endpoint
